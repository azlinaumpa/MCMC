            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item active">
                    <a class="sidebar-link" href="/dashboard">
                        <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Dashboard1</span>
                    </a>
                </li>
                @elseif(auth()->user()->role == 'user')
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/dashboard">
                        <i class="align-middle" data-feather="user"></i> <span class="align-middle">Dashboard2</span>
                    </a>
                </li>
                @else
                <li class="sidebar-item">
